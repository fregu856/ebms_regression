...
This repository contains code for the experiments on _**object detection**_, _**age estimation**_ (TODO!), _**head-pose estimation (TODO!)**_ and _**1D regression**_. Code for the _**visual tracking**_ experiments is available at [pytracking](https://github.com/visionml/pytracking).
