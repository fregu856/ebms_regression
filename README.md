...
This repository contains code for the experiments on _object detection_ and _1D regression_. Code for the _visual tracking_ experiments is available at [pytracking](https://github.com/visionml/pytracking).
