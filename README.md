...
This repository contains code for the experiments on object detection and 1D regression. Code for the visual tracking experiments is available at [pytracking](https://github.com/visionml/pytracking).
