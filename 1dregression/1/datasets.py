...
#
# with open("/root/ebms_regression/1dregression/1/x.pkl", "wb") as file:
#     pickle.dump(x, file)
# with open("/root/ebms_regression/1dregression/1/y.pkl", "wb") as file:
#     pickle.dump(y, file)
#
#
#
...
#
# with open("/root/ebms_regression/1dregression/1/gt_x_values_2_scores.pkl", "wb") as file:
