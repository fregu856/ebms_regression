...
model_id = "paper1_2-sm"

network = ToyNet(model_id, project_dir="/root/project3/toyRegression").cuda()

epoch = 75

network.load_state_dict(torch.load("/root/project3/toyRegression/training_logs/model_%s_1/checkpoints/model_%s_epoch_%d.pth" % (model_id, model_id, epoch)))
