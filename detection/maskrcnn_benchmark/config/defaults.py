...
_C.MODEL.IOU_PRED_ON = False
_C.MODEL.BBREG_UN_ON = False
_C.MODEL.RETINANET_ON = False
_C.MODEL.KEYPOINT_ON = False
_C.MODEL.DEVICE = "cuda"
_C.MODEL.META_ARCHITECTURE = "GeneralizedRCNN"
_C.MODEL.CLS_AGNOSTIC_BBOX_REG = False
_C.MODEL.CLS_AGNOSTIC_IOU_PRED = False
...
_C.MODEL.ROI_BOX_HEAD.POOLER_TYPE = 'roi_align'
...
_C.MODEL.ROI_BOX_HEAD.PERFORM_FILTERING = True

_C.MODEL.ROI_BOX_UN_HEAD = CN()
_C.MODEL.ROI_BOX_UN_HEAD.PREDICTOR = "FPNUnPredictor"
_C.MODEL.ROI_BOX_UN_HEAD.FEATURE_EXTRACTOR = "ResNet50Conv5ROIFeatureExtractor"
_C.MODEL.ROI_BOX_UN_HEAD.POOLER_TYPE = 'roi_align'
_C.MODEL.ROI_BOX_UN_HEAD.POOLER_RESOLUTION = 14
_C.MODEL.ROI_BOX_UN_HEAD.POOLER_SAMPLING_RATIO = 0
_C.MODEL.ROI_BOX_UN_HEAD.POOLER_SCALES = (1.0 / 16,)
_C.MODEL.ROI_BOX_UN_HEAD.NUM_CLASSES = 81
_C.MODEL.ROI_BOX_UN_HEAD.LOSS_TYPE = "Laplace"

# Hidden layer dimension when using an MLP for the RoI box head
_C.MODEL.ROI_BOX_UN_HEAD.MLP_HEAD_DIM = 1024
# GN
_C.MODEL.ROI_BOX_UN_HEAD.USE_GN = False
_C.MODEL.ROI_BOX_UN_HEAD.PERFORM_FILTERING = True
_C.MODEL.ROI_BOX_UN_HEAD.TRAIN_HEAD = True

_C.MODEL.ROI_IOU_HEAD = CN()
_C.MODEL.ROI_IOU_HEAD.FEATURE_EXTRACTOR = "FPN2MLPFeatureExtractor"
_C.MODEL.ROI_IOU_HEAD.PREDICTOR = "IoUNetPredictor"
_C.MODEL.ROI_IOU_HEAD.POOLER_TYPE = 'roi_align'
_C.MODEL.ROI_IOU_HEAD.POOLER_RESOLUTION = 14
_C.MODEL.ROI_IOU_HEAD.POOLER_SCALES = (1.0 / 16,)

_C.MODEL.ROI_IOU_HEAD.MLP_HEAD_DIM = 1024
# GN
_C.MODEL.ROI_IOU_HEAD.USE_GN = False

_C.MODEL.ROI_IOU_HEAD.DILATION = 1
_C.MODEL.ROI_IOU_HEAD.CONV_HEAD_DIM = 256
_C.MODEL.ROI_IOU_HEAD.NUM_STACKED_CONVS = 4
_C.MODEL.ROI_IOU_HEAD.PERFORM_FILTERING = True

_C.MODEL.ROI_IOU_HEAD.LOSS_TYPE = "L2"
_C.MODEL.ROI_IOU_HEAD.PROPOSAL_SAMPLING_TYPE = "default_iou"
_C.MODEL.ROI_IOU_HEAD.STEP_LENGTH = (0.5, 0.5)
_C.MODEL.ROI_IOU_HEAD.STEP_LENGTH_DECAY = 1.0
_C.MODEL.ROI_IOU_HEAD.NUM_REFINE_ITER = 5
_C.MODEL.ROI_IOU_HEAD.GT_SIGMA = (0.125, 0.125)
_C.MODEL.ROI_IOU_HEAD.PROPOSAL_SIGMA = ((0.125, 0.125), (0.25, 0.25), (0.5, 0.5), (1.0, 1.0))

_C.MODEL.ROI_IOU_HEAD.NUM_TRAIN_PROPOSALS = 16
_C.MODEL.ROI_IOU_HEAD.MIN_OVERLAP_PROPOSAL = 0.5
_C.MODEL.ROI_IOU_HEAD.TRAIN_HEAD = True
_C.MODEL.ROI_IOU_HEAD.NMS_BEFORE = True

_C.MODEL.ROI_IOU_HEAD.LANGEVIN_L = 1
_C.MODEL.ROI_IOU_HEAD.LANGEVIN_alpha = 1.0

_C.MODEL.ROI_IOU_HEAD.NCEPLUS_beta = 0.0
...
_C.SOLVER.LAPLACE_FT_MODE = False
_C.SOLVER.LAPLACE_LR_FACTOR = 1.0
# ---------------------------------------------------------------------------- #
